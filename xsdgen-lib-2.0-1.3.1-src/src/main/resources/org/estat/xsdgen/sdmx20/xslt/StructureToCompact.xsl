     ...
     <xsl:template match="/">
          ...
          <xs:schema>
               ...
               <xsl:element name="xs:import">
                    <xsl:attribute name="namespace"><xsl:text>http://www.SDMX.org/resources/SDMXML/schemas/v2_0/compact</xsl:text></xsl:attribute>
               ...
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              ...
                              <!--Close xs:choice-->
                              <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:Attribute[@attachmentLevel='DataSet']">
                              ...
                              <xsl:element name="xs:extension">
                                   ...
                                   <xsl:for-each select="structure:DimensionRef">
                                        <xsl:element name="xs:attribute">
                                             ...
                                             <xsl:attribute name="type">
                                                  <xsl:variable name="dimension" select="/message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:Dimension[@conceptRef = $Concept]" />
                                                  <xsl:choose>
                                                       <xsl:when test="$dimension/@codelist">
                                                            <xsl:value-of select="$dimension/@codelist"/>
                                                       </xsl:when>
                                                       <xsl:otherwise>
               ...
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              ...
                              <!--Close xs:sequence-->
                              <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:Attribute[@attachmentLevel='Series']">
                                   <xsl:element name="xs:attribute">
                                        <xsl:attribute name="name"><xsl:value-of select="@conceptRef"/></xsl:attribute>
                                        <xsl:attribute name="type">
                                             <xsl:if test="@codelist">
                              ...
                              <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:Dimension">
                                   <xsl:element name="xs:attribute">
                                        <xsl:attribute name="name"><xsl:value-of select="@conceptRef"/></xsl:attribute>
                                        <xsl:attribute name="type">
                                             <xsl:if test="@codelist">
                         ...
                         <xsl:element name="xs:extension">
                              ...
                              <xsl:element name="xs:attribute">
                                   <xsl:attribute name="name">
                                        <xsl:value-of select="message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:TimeDimension/@conceptRef"/>
                                   </xsl:attribute>
                              ...
                              <xsl:element name="xs:attribute">
                                   <xsl:variable name="primaryMeasure" select="message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:PrimaryMeasure" />
                                   <xsl:attribute name="name">
                                   ...
                                   <xsl:attribute name="type">
                                        <xsl:choose>
                                             ...
                                             <xsl:otherwise>
                                                  <xsl:value-of select="$primaryMeasure/@conceptRef"/><xsl:text>Type</xsl:text>
                                             </xsl:otherwise>
                                        </xsl:choose>
                                   </xsl:attribute>
                                   <xsl:attribute name="use"><xsl:text>optional</xsl:text></xsl:attribute>
                              </xsl:element>
                              <!--Close xs:element (Primary Measure)-->
               ...
               <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[$KeyFamily]/structure:Components/structure:PrimaryMeasure[not(@codelist)] | 
